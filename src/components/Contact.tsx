              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <motion.div
                    ...
                    transition={{ delay: 0.2 }}
                  >
                    <div className="w-12 h-12 bg-gradient-to-r from-gojo-blue to-gojo-purple rounded-full flex items-center justify-center">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      ...
                      <p className="text-white font-semibold">{portfolioData.personal.phone}</p>
                    </div>
                  </motion.div>
