                ...
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {social.icon === 'onlinejobs' && (
                      <path d="M20 6h-2.18l.86-2.88c.08-.24.12-.49.12-.74 0-.41-.15-.8-.44-1.09C18.06 1.02 17.67.87 17.26.87c-.41 0-.8.15-1.09.44L14.12 3.36c-.29.29-.44.68-.44 1.09 0 .25.04.5.12.74L14.66 8H9.34l.86-2.88c.08-.24.12-.49.12-.74 0-.41-.15-.8-.44-1.09C9.59 3.02 9.2 2.87 8.79 2.87c-.41 0-.8.15-1.09.44L5.65 5.36c-.29.29-.44.68-.44 1.09 0 .25.04.5.12.74L6.18 10H4c-1.11 0-2 .89-2 2v8c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2v-8c0-1.11-.89-2-2-2zm-2 2v6H6v-6h12z"/>
                    )}
                  </svg>
                </motion.a>
              ))}
